...
<html lang="fr">
  ...
  <head>
    <meta charset="UTF-8">
    <title>Formulaire Connexion/Inscription avec effet</title>
...
<div id="container">
        <div class="login">
            <div class="content">
                ...
                <form>
                    ...
                    <span class="forget">Mot de passe oublié ?</span>
                    <span class="clearfix"></span>
                    <button onclick="return false;">Se connecter</button>
                </form>
        ...
        <div class="page back">
                <div class="content">
                    ...
                    <button type="" id="login"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left-circle"><circle cx="12" cy="12" r="10"/><polyline points="12 8 8 12 12 16"/><line x1="16" y1="12" x2="8" y2="12"/></svg> Connexion</button>
            </div>
        </div>
        <div class="register">
            <div class="content">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                    ...
                    <svg class="feather feather-linkedin sc-dnqmqq jxshSx" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                                    ...
                                    <span class="loginwith">Ou</span>

                    <form>
                        <input type="text" placeholder="nom">
                        <input type="email" placeholder="e-mail">
                        <input type="password" placeholder="mot de passe"> 
                            <span class="remember">J'accepte les conditions</span> 
                            <span class="clearfix"></span>
                        <button onclick="return false;">S'inscrire</button>
                 </form>
            </div>		
        </div>
</div>

<a href="https://codepen.io/eminqasimov/full/KYrVBr" target="_blank" class="version">Version animée</a>
